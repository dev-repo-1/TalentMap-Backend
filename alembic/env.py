...
def get_sync_url() -> str:
    """
    Alembic runs migrations with a synchronous engine.
    Converts app async URLs to psycopg v3 sync (works on Windows; no ProactorEventLoop issues).
    """
...
def run_migrations_offline() -> None:
    assert_database_url_configured(settings.database_url)
    context.configure(
        url=get_sync_url(),
